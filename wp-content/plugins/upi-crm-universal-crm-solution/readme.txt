=== UpiCRM – Lead Management & Contact Form DB for WordPress - Free ===

Author: UpiCRM.com
Contributors: UpiCRM.Com
Plugin URI: https://www.upicrm.com/
Author URI: https://www.upicrm.com/
Donate link: https://www.upicrm.com/contact/
Tags: Lead Management, contact form DB, contact form 7 DB, Wordpress Lead Management, Inbound Lead Management, WordPress CRM, Free WordPress CRM, Free CRM for WordPress, CRM,  UPICRM, UTM tagging, HTTP referrer mysql , sql,datatables, generator
Stable tag: 5.2.0
Version: 2.2.4.2
Tested up to: 5.2.0
Requires at least: 3.0.1
License: GPLv2 or later
License URI: https://www.upicrm.com/wp-content/uploads/2015/03/license.txt


UpiCRM – Ultimate Lead Management and contact form DB - manage and store all forms entries from any forms plugin on WordPress site.
...
UpiCRM: Free WordPress Lead Management & contact form DB and entry management for inbound marketing - solution/plug-in. Centrally manage, collect, and protect your leads and forms entries from all forms on your website. Use the advanced GDPR features, aggregate leads from multiple websites, distribute leads automatically to your team members, integrate with CRM systems, webservices, and Google drive - and much much more!

Have all your inbound leads managed in a central location, aggregate leads from multiple sites, assign and distribute leads to team members and partners, automate lead managment process - all easy and quick to configure. 


UpiCRM is designed to easily integrate with your WordPress website.

Upi collects leads aentries from your existing forms plugins/solutions you are currently using, such as  - WPforms, Contact Form7, Contact Form 7 DB, Gravity Form, Ninja Forms, CalderaForms, Cforms and any other contact forms in order to collect and mange leads and customers from your website.
