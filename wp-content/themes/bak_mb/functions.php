...
function my_style_script(){
    ...
    wp_enqueue_script('jqueryui', get_template_directory_uri().'/js/jquery-ui.js',array(),null,true);
    wp_enqueue_script('parallax', get_template_directory_uri().'/js/parallax.js',array(),null,true);
